...
#        if self.memory_counter> self.memory_size / 2 and self.memory_counter % self.training_interval == 0:
    ...
    def knm(self, m, k = 1):
        ...
        # Therefore, we compare it with '0' instead of 0.5 in equation (8). Since, sigmod(0) = 0.5. 0.7的阈值对应0.847
        m_list.append(1*(m>0.847))
